      ...
      body: ListView(
        children: [
          ListTile(
              title: Text(
                'Healthy',
                style: TextStyle(fontSize: 40, color: fon),
              ),
              subtitle: Row(
                children: [
                  Icon(
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: c2, borderRadius: BorderRadius.circular(20)),
                  child: Column(
                    children: [
                      Row(
                        children: [
                      ...
                      Container(
                        ...
                        child: CircularPercentIndicator(
                          ...
                          center: new Text(
                            "50%",
                            style: TextStyle(fontSize: 50, color: pro1),
                          ),
                          progressColor: pro2,
                        ),
                      ),
              ...
              Column(
                children: [
                  Padding(
                    padding:
                        const EdgeInsets.only(top: 30, left: 5, bottom: 10),
                    child: Container(
                ...
                children: [
                  ...
                  Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            ' sting heart rate is 60-100/min',
                            style: TextStyle(
                              fontSize: 22,
                              color: fon,
                            ),
                  ...
                  Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            'Comeeeeee on! Another goal wwwwwwwwwwwwwwwwwww',
                            style: TextStyle(
                              fontSize: 22,
                              color: fon,
                            ),
